...
songplay_table_create = """CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time TIME NOT NULL, user_id VARCHAR NOT NULL, level VARCHAR, song_id VARCHAR, artist_id VARCHAR, session_id INT NOT NULL, location VARCHAR, user_agent VARCHAR);"""

user_table_create    = """CREATE TABLE IF NOT EXISTS users (user_id VARCHAR PRIMARY KEY, first_name VARCHAR, last_name VARCHAR, gender VARCHAR NOT NULL, level VARCHAR);"""

song_table_create    = """CREATE TABLE IF NOT EXISTS songs (song_id VARCHAR PRIMARY KEY, title VARCHAR, artist_id VARCHAR NOT NULL, year INT NOT NULL, duration NUMERIC NOT NULL);"""
...
time_table_create   = """CREATE TABLE IF NOT EXISTS time (start_time TIME PRIMARY KEY, hour INT NOT NULL, day INT NOT NULL, week INT NOT NULL, month INT NOT NULL, year INT NOT NULL, weekday INT NOT NULL);"""
